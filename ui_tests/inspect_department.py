        ...
        if add_btn:
            ...
            if modal:
                ...
                if dept_select:
                    ...
                    # 查找下拉选项
                    dropdown = page.query_selector('.ant-select-dropdown')
                    if dropdown:
                        options = dropdown.query_selector_all('.ant-select-item')
                    ...
                    # 填写其他字段
                    page.fill('#merchantName', '测试商家_v9')
                    page.fill('#aliasName', '测试商家')
                    page.fill('#mobile', '13800138000')
                    page.fill('#wechatNumber', 'test_wechat')
                    
                    # 截图
                    page.screenshot(path='/Users/lanwang/Documents/trae_projects/new World/form_with_dept.png')
                    ...
                    if confirm_btn:
                        ...
                        page.screenshot(path='/Users/lanwang/Documents/trae_projects/new World/result.png')
